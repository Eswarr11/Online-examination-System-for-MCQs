...
<div class="form-group">
  ...
  <div class="col-md-12">
  <input id="mob" name="mob" placeholder="Enter your mobile number" class="form-control input-md" type="number" max="9999999999"> 
  </div>
</div>
...
<div class="modal fade title1" id="developers">
  <div class="modal-dialog">
    ...
    <h4 style="font-family:'typo' ">abc2003@gmail.com</h4>
      ...
      <div class="modal-body title1">
        ...
        <div class="row">
          ...
          <div class="col-md-12" style="font-family: 'typo';">
            Its is a online exam softwware to condut online exams for MCQ's.
</div>
</div>
</p>
</div>
